...
export const rankingDojang = async ({
  ...
  try {
    return await client().get('ranking/dojang', { params: { ocid, date, world_name, difficulty, class_name, page } }) as DojangRanking
  } catch (e) {
    return Promise.reject(e)
  }
}
